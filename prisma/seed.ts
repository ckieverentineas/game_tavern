...
async function main() {
  ...
  const demoGuild = await prisma.guild.create({
    data: {
      ...
      marketSlotsBase: 2,
      activeHeroSlots: 5,
      publicTitleKey: "trade-league",
      crestKey: "ledger",
      signatureColorKey: "dawn",
      motto: "Books open, promises kept.",
      publicBio: "A polished broker-house that turns contracts, repeat business, and expedition discipline into public trust.",
      createdAt: daysAgo(14),
    },
  });
  ...
  const rivalGuild = await prisma.guild.create({
    data: {
      ...
      marketSlotsBase: 3,
      activeHeroSlots: 4,
      publicTitleKey: "embersworn-hall",
      crestKey: "scales",
      signatureColorKey: "ember",
      motto: "Demand bends before prepared fire.",
      publicBio: "A hard-edged demand broker that pressures rivals through buy orders, fast fulfillment, and visible market heat.",
      createdAt: daysAgo(21),
    },
  });
  ...
  const [cinderGuild, mossGuild] = await Promise.all([
    prisma.guild.create({
      data: {
        ...
        crestKey: "ember",
        signatureColorKey: "royal",
        motto: "The frontier remembers our banners.",
        publicBio: "An expedition-heavy war band whose public name is built on elite clears, ambitious routes, and visible prestige spikes.",
        createdAt: daysAgo(30),
      },
    }),
    prisma.guild.create({
      data: {
        ...
        marketSlotsBase: 1,
        activeHeroSlots: 4,
        publicTitleKey: "lantern-court",
        crestKey: "lantern",
        signatureColorKey: "moss",
        motto: "Small lights still gather a road.",
        publicBio: "A rising house using soft endorsements, early trade, and careful growth to turn a fresh tag into a remembered name.",
        createdAt: daysAgo(11),
      },
    }),
  ]);
